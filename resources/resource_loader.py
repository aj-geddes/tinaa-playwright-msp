...
class ResourceLoader:
    ...
    def load_resources(self):
        ...
        self._load_json_resource("accessibility_guidelines.json", "accessibility_guidelines")
    ...
    def _load_json_resource(self, filename: str, resource_key: str):
        ...
        try:
            with open(self.resources_dir / filename, "r") as f:
    ...
    def get_testing_strategy(self, strategy_name: str) -> Optional[Dict[str, Any]]:
        """Get a specific testing strategy"""
        return self.resources.get("testing_strategies", {}).get(strategy_name)
    
    def get_heuristic(self, heuristic_name: str) -> Optional[Dict[str, Any]]:
        """Get a specific heuristic"""
        return self.resources.get("heuristics", {}).get(heuristic_name)
    
    def get_credentials(self, site_name: str) -> Optional[Dict[str, str]]:
